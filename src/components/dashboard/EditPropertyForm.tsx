...
export function EditPropertyForm({ property }: EditPropertyFormProps) {
  ...
  const [category, setCategory] = useState<string | null>(property.category);
  const [priority, setPriority] = useState<string | null>(property.priority);
  ...
  return (
    <div
      className="rounded-2xl p-5 sm:p-8 max-w-3xl w-full"
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        <TextField name="title" isRequired defaultValue={property.title}>
          <Label>Title</Label>
          <Input placeholder="e.g. Modern 3-Bed Apartment in Gulshan" />
          <FieldError />
        </TextField>

        <TextField name="shortDescription" isRequired defaultValue={property.shortDescription}>
          <Label>Short Description</Label>
          <TextArea rows={2} />
          <FieldError />
        </TextField>

        <TextField name="fullDescription" isRequired defaultValue={property.fullDescription}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <div className="flex flex-col gap-1">
            ...
            <Select
              defaultSelectedKey={property.category}
          ...
          <div className="flex flex-col gap-1">
            ...
            <Select
              defaultSelectedKey={property.priority}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
          <TextField name="price" type="number" isRequired defaultValue={String(property.price)}>
            <Label>Price</Label>
            <Input min={0} />
            <FieldError />
          </TextField>

          <TextField name="location" isRequired defaultValue={property.location}>
        ...
        <TextField name="imageUrl" defaultValue={property.imageUrl ?? ""}>
          ...
          <Description>Optional — leave blank to remove image</Description>
        </TextField>
